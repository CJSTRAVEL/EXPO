...
import { LayoutDashboard, Users, Calendar, Car, UserCircle, KeyRound, Building2, FileText, Inbox, PlusCircle, Truck, Settings, LogOut, MessageSquare } from "lucide-react";
...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { path: "/message-templates", icon: MessageSquare, label: "Message Templates" },
  ];
